...
export async function GET(req: NextRequest) {
  // Keep one embedded font so this route stays below Vercel's Edge Function
  // bundle limit. The general OG route follows the same single-font pattern.
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div tw="flex flex-col text-white" style={{ marginLeft: "48px" }}>
        <div tw="flex text-7xl font-bold mb-4 tracking-tighter">Papermark</div>
      ...
      >
        ...
        <div tw="flex flex-col p-8 border-t border-white/20 h-[240px] justify-center">
          ...
          <div tw="flex text-2xl font-normal text-white/80">minutes viewed</div>
        </div>
